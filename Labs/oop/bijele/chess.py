...
class Chess:
    def __init__(self, king=1, queen=1, rooks=2, bishops=2, knights=2, pawns=8):
        ...
        self.rooks = rooks  # FIXME
        self.bishops = bishops  # FIXME
        self.knights = knights  # FIXME
        self.pawns = pawns  # FIXME
    ...
    def __sub__(self, other: 'Chess'):
        ...
        b_diff = self.bishops - other.bishops  # FIXME
        kn_diff = self.knights - other.knights  # FIXME
        p_diff = self.pawns - other.pawns  # FIXME
